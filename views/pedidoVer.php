                ...
                <table class="table table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($pedido['status'] == '1'): ?>
                                <a href="<?php echo BASE_URL."/pedido/excluir/".$produto['id_pedido']."/".$produto['id_produto']."/".$produto['id']; ?>" class="btn btn btn-danger" data-toggle="tooltip" data-placement="top" title="Excluir" ><i class="glyphicon glyphicon-remove"></i></a>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
